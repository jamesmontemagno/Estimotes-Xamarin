...
namespace Estimotes.Droid
{
    ...
    public class NotifyDemoActivity : Activity, BeaconManager.IServiceReadyCallback
    {
        ...
        {
            var notifyIntent = new Intent(this, GetType());
            notifyIntent.SetFlags(ActivityFlags.SingleTop);

            var pendingIntent = PendingIntent.GetActivities(this, 0, new [] { notifyIntent }, PendingIntentFlags.UpdateCurrent);
            ...
            var statusTextView = FindViewById<TextView>(Resource.Id.status);
